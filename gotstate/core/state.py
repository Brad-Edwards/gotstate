...
from gotstate.core.types import EffectFunction, GuardFunction, StateData, StateType
...
class CompositeState(State):
    ...
    def regions(self) -> Dict[str, "Region"]:
        """Get the dictionary of regions by ID."""
...
class PseudoState(State):
    ...
    def __init__(
        ...
        super().__init__(state_id=state_id, state_type=state_type, parent=parent, data=data)
...
class HistoryState(PseudoState):
    ...
    VALID_TYPES = {StateType.SHALLOW_HISTORY, StateType.DEEP_HISTORY}
...
class ConnectionPointState(PseudoState):
    ...
    VALID_TYPES = {StateType.ENTRY_POINT, StateType.EXIT_POINT}
...
class ChoiceState(PseudoState):
    ...
    def __init__(self, state_id: str, parent: Optional["State"] = None, data: Optional[Dict[str, Any]] = None) -> None:
        ...
        Args:
            ...
            data: Optional state data dictionary
        """
        super().__init__(state_id=state_id, state_type=StateType.CHOICE, parent=parent, data=data)
...
class JunctionState(PseudoState):
    ...
    def __init__(self, state_id: str, parent: Optional["State"] = None, data: Optional[Dict[str, Any]] = None) -> None:
        ...
        Args:
            ...
            data: Optional state data dictionary
        """
        super().__init__(state_id=state_id, state_type=StateType.JUNCTION, parent=parent, data=data)
        self._default_transition: Optional["Transition"] = None
        self._outgoing_transitions: List["Transition"] = []
